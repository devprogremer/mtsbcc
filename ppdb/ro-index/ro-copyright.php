...
<hr class="medium">
<p class="text-muted" style="font-size: 12px;">Copyright &copy; IT Development <?php echo "$row[nama_sekolah]";?> - Proudly powered by <a href="https://www.root93.co.id" target="_blank">root93 team</a></p>
</div>
</section>
</footer>
