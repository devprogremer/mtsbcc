  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
          ...
          <div class="section-title">
          <p><i class="bi bi-fast-forward-btn-fill"></i>VISI</p>
          <li><i class="bi bi-caret-right-fill"></i> Memberi kontribusi kepada program pemerintah Indonesia terkait penyediaan lembaga pendidikan yang memberi kesempatan kepada anak usia MTs/SMP, khususnya Muslim, untuk memperoleh pendidikan dasar berkualitas.</li>
          ...
          <li><i class="bi bi-caret-right-fill"></i> Mengembangkan pribadi peserta didik agar menjadi individu Muslim yang baik, memiliki kecakapan dan motivasi berwirausaha, serta mampu bergaul dengan masyarakat. </li>
          </div>
          <div class="section-title">
