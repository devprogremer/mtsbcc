      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="assets/img/kelas.jpeg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
          <div class="section-title">
          <h2>Sarana Kelas </h2>
          <p>MT Bina Cendekia Cirebon </p>
        </div>
            <ul>
          <p> Dengan kelas yang nyaman kamu dapat belajar dengan optimal, maka dari itu MTs Bina Cendekia Cirebon, menyediakan kelas yang memadai bagi kalian semua supaya kegiatan belajar dan mengajar menjadi lebih maksimal.
            <p>
          </div>
        </div>
